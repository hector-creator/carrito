      ...
      <button type="button" class="btn btn-secondary btn-sm dropdown-toggle" id="dropdownMenuOffset" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  ...
                  <div class="btn-group">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuReference">
                      ...
                      <a class="dropdown-item" href="#">Precio, bajo to alto</a>
                      <a class="dropdown-item" href="#">Precio, alto to bajo</a>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <?php 
             ...
             /* for($i=0;$i<50;$i++){
                $conexion->query("insert into productos (nombre, descripcion,precio,imagen, inventario, id_categoria,capacidad,color) values(
   'Producto $i','Esta es la descripcion',".rand(10,1000).",'shoe_1.jpg',".rand(1,100).",1,'XL','Blue'
