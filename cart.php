...
<html lang="en">
  ...
  <?php include("./layouts/header.php"); ?> 
    ...
    <div class="site-section">
       ...
       $total= $total + ( $arregloCarrito[$i]['Precio'] * $arregloCarrito[$i]['Cantidad'] );
                ?>
                  <tr>
                    ...
                    <td>
                      <div class="input-group mb-3" style="max-width: 120px;">
                        <div class="input-group-prepend">
                          <button class="btn btn-outline-info js-btn-minus btnIncrementar" type="button">&minus;</button>
                        </div>
                        ...
                        <div class="input-group-append">
                          <button class="btn btn-outline-info js-btn-plus btnIncrementar" type="button">&plus;</button>
                        </div>
                      </div>
                    ...
                    <td><a href="#" class="btn btn-info btn-sm btnEliminar" data-id="<?php echo $arregloCarrito[$i]['Id'];?>">X</a></td>
                  </tr>
      ...
      <button class="btn btn-info btn-sm btn-block">Actualizar la compra</button>
              </div>
              <div class="col-md-6">
          <button class="btn btn-outline-info btn-sm btn-block">Seguir comprando</button>
              </div>
            </div>
            <div class="row">
              <div class="col-md-12">
              ...
              <div class="col-md-4">
                <button class="btn btn-info btn-sm">Aplicar cupón</button>
              </div>
            </div>
          </div>
          <div class="col-md-6 pl-5">
            <div class="row justify-content-end">
              <div class="col-md-7">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <button class="btn btn-info btn-lg py-3 btn-block" onclick="window.location='checkout.php'">Pasar por la caja</button>
                  </div>
                </div>
              </div>
            </div>
