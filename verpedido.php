...
<html lang="en">
  <head>
    <title>Pinturas &mdash; Contimex</title>
    <meta charset="utf-8">
...
<span class="d-block text-info h6 text-uppercase"><?php echo $f['nombre_producto'];?></span> <br>
<span class="d-block text-info h6 text-uppercase">Cantidad:<?php echo $f['cantidad'];?></span>
<span class="d-block text-info h6 text-uppercase">Precio:<?php echo $f['precio'];?></span>
<span class="d-block text-info h6 text-uppercase">Subtotal:<?php echo $f['subtotal'];?></span>
            </div>
              <?php } ?>
