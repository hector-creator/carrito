...
<div class="wrapper">
  ...
  <div id="collapse<?php echo $f['id'];?>" class="collapse" aria-labelledby="heading<?php echo $f['id'];?>" data-parent="#accordionExample">
                <div class="card-body">
                    ...
                    <p >Status: <b><?php echo $f['status']; ?></p></b>
      ...
      <?php 
    $re=$conexion->query("select  productos_venta.*, productos.nombre, productos.capacidad, productos.color
        ...
        <form action="../php/insertarproducto.php" method="POST" enctype="multipart/form-data">
          ...
          <div class="modal-body">
              ...
              <div class="form-group">
                  ...
                  <input type="text" name="capacidad" placeholder="capacidad" id="capacidad" class="form-control" required>
              </div>
              <div class="form-group">
      ...
      <div class="modal-content">
        <form action="../php/editarproducto.php" method="POST" enctype="multipart/form-data">
          ...
          <div class="modal-body">
              ...
              <div class="form-group">
                  <label for="apacidadEdit">Capacidad</label>
                  <input type="text" name="capacidad" placeholder="capacidad" id="capacidadEdit" class="form-control" required>
              </div>
              <div class="form-group">
                  <label for="capacidadEdit">Color</label>
